   ...
   <>
    <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
       <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md">
         <h1 className={`text-[#d6842b] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-6xl 2xl:text-8xl`}>
          Register
         </h1>
         <form className='flex flex-col gap-5 w-full' onSubmit={handleRegister}>
            ...
            <div className='flex flex-col sm:flex-1 gap-2'>
                 <label className='text-[16px] text-stone-600'>
                  ...
                  <div className='flex items-center gap-3'>
                      ...
                      <input type="file" onChange={imageHandeler}/>
                  </div>
            ...
            <div className='flex flex-col gap-4 '>
               ...
               <div className='flex flex-col gap-2 '>
                   <label className='text-[16px] text-stone-500 font-semibold'>Bank Details</label>
                   <div className='flex flex-col gap-1 sm:flex-row sm:gap-4'>
                       ...
                       <input type='text ' value={bankAccountNumber} placeholder='Enter Your A/C Number' onChange={(e)=>setBankAccountNumber(e.target.value)} className='text-[16px] py-2 bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none sm:flex-1' disabled={role==="Bidder"}/>
                   </div>
                   <div className='flex flex-col gap-1 sm:flex-row sm:gap-4'>
                     <input type='text ' value={bankAccountHolderName} placeholder={`Enter A/C Holder's Name`} onChange={(e)=>setBankAccountHolderName(e.target.value)} className='text-[16px] py-2 bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none sm:flex-1' disabled={role==="Bidder"}/>
                     <input type='text ' value={bankAccountIfsc} placeholder={`Enter IFSC Code`} onChange={(e)=>setBankAccountIfsc(e.target.value)} className='text-[16px] py-2 bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none sm:flex-1' disabled={role==="Bidder"}/>
                  </div>
               </div>
               <div>
                   <label className='text-[16px] text-stone-500 font-semibold'>
                    ...
                    <div className='flex flex-col gap-1 sm:flex-row sm:gap-4'>
                        <input type="text" value={upiId} placeholder='UPI Id' onChange={(e)=>setUpiId(e.target.value)} className='text-[16px] py-2 bg-transparent border-b-[1px] border-b-stone-500 focus:outline-none sm:flex-1' disabled={role==="Bidder"}/>
            ...
            <button className='bg-[#d6482b] font-semibold hover:bg-[#b8381e] transition-all duration-300 text-xl py-2 px-4 rounded-md text-white w-[280px] mx-auto lg:w-[640px] my-4' type="submit" disabled={loading}>{loading && "Registering..."} {!loading && "Register"}</button>
         </form>
       </div>
    </section>
   </>
