        ...
        <>
         <div className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col gap-10">
          ...
          <div className='flex flex-col gap-10'>
            <div>
              <h3 className="text-[#4b4a4a] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">Monthly Total Payments Received</h3>
              <PaymentGraph/>
            </div>
            <div>
              <h3 className="text-[#4b4a4a] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">Users</h3>
              <BiddersAuctioneersGraph/>
            </div>
            <div>
              <h3 className="text-[#4b4a4a] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">Payment Proofs</h3>
              <PaymentProofs/>
            </div>
            <div >
              <h3 className="text-[#4b4a4a] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">Delete Item From Auction</h3>
              <AuctionItemDelete/>
            </div>
          </div>
         </div>
