...
const PaymentProofs = () => {
  ...
  useEffect(() => {
    if (singlePaymentProof && Object.keys(singlePaymentProof).length > 0) {
      ...
      setOpenDrawer(false);  // Recheck Needed
    }
  }, [singlePaymentProof]);
  return (
    <>
  ...
  return (
    <>
      <section
        ...
        } left-0 w-full overflow-y-auto transition-all duration-300 h-full bg-[#00000087] flex items-end`}
      >
        <div className="bg-white h-[100vh] transition-all duration-300 w-full overflow-y-auto">
            ...
            <form className="flex flex-col gap-5 my-5">
              ...
              <div className="flex flex-col gap-3">
                ...
                <select
                  ...
                  className="text-xl px-1 py-2 bg-transparent border-[1px] border-stone-600 rounded-md focus:outline-none cursor-pointer"
                >
              ...
              <div>
                <Link
                  ...
                  className="bg-[#D6482B] flex justify-center w-full py-2 rounded-md text-white font-semibold text-xl transition-all duration-300 hover:bg-[#b8381e]"
                   target="_blank"
                >
                  Payment Proof (Statement/ScreenShot)
                </Link>
              </div>
              <div>
                <button
                  type="button"
                  className="bg-blue-600 flex justify-center w-full py-2 rounded-md text-white font-semibold text-xl transition-all duration-300 hover:bg-blue-800"
