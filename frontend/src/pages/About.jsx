...
const About = () => {
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 gap-7 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <div>
          <h1
            className={`text-[#d6842b] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-6xl 2xl:text-8xl`}
          >
            About Us
          </h1>
          <p className="text-xl text-stone-600">
            Welcome to AuctionBharat, the ultimate destination for online
            auctions and bidding excitement. Founded in 2025, we are dedicated
        ...
        <div>
          <h3 className={`text-slate-700 text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl`}>
              Our Mission
          </h3>
          <p className="text-xl text-stone-600">
            At AuctionBharat, our mission is to revolutionize the way people buy and
                ...
                values.map(element=>{
                   return(
                    <li className="text-xl text-stone-600 mb-2 " key={element.id}>
                        <span className="text-slate-500 font-bold">{element.title}</span>: {element.description}
                    </li>
                   ) 
                })
            }
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Founded by Ayan Pal, AuctionBharat was born out of a passion for
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Whether you're looking to buy, sell, or simply explore, AuctionBharat
        ...
        <div>
          <p className="text-[#d6482b] text-xl font-bold mb-3">
            Thank you for choosing AuctionBharat. We look forward to being a part of
